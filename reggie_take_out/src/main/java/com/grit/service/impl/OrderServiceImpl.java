...
import com.grit.mapper.OrderMapper;
import com.grit.service.*;
...
public class OrderServiceImpl extends ServiceImpl<OrderMapper, Orders> implements OrderService {
    ...
    public IPage<Orders> getPage(int page, int pageSize) {
        Long userId = BaseContext.getCurrentId();
        IPage<Orders> getPage = new Page<>(page, pageSize);
        LambdaQueryWrapper<Orders> lqw = new LambdaQueryWrapper<>();
        lqw.eq(Orders :: getUserId, userId)
                .orderByDesc(Orders :: getCheckoutTime);
        this.page(getPage, lqw);
        return getPage;
    }
}
